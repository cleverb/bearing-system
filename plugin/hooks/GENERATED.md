<!-- DO NOT EDIT. Generated from plugin/src/bearing/manifests.py by bearing 0.1.0. Run `bearing render` to update; edits here are overwritten and reported as drift by `bearing render --check`. -->

# Generated directory — do not edit

Every file here is generated from `plugin/plugin.json` by `bearing package`.

Cursor reads hook configuration from `hooks/hooks.json` inside a plugin. This one backs ephemeral projections via the `workspaceOpen` event.
