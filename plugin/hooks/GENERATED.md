<!-- DO NOT EDIT. Generated from plugin/src/bearing/manifests.py by bearing 0.2.0. Run `bearing render` to update; edits here are overwritten and reported as drift by `bearing render --check`. -->

# Generated directory — do not edit

Every file here is generated from `plugin/plugin.json` by `bearing package`.

Claude reads `hooks/hooks.json` by convention; Cursor's manifest points at `hooks/cursor.json`. Their incompatible schemas are generated separately.
